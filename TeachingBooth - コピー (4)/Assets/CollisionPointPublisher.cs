...
{
    public class CollisionPointPublisher : Publisher<Messages.Geometry.PoseStamped>
    {
        ...
        private Messages.Geometry.Point GetGeometryPoint()
        {
            ...
            geometryPoint.x = CollisionPoint.hitPos.z;
            geometryPoint.y = -CollisionPoint.hitPos.x;
            geometryPoint.z = CollisionPoint.hitPos.y;
