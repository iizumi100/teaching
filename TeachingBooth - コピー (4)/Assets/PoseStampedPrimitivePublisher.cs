...
{
    public class PoseStampedPrimitivePublisher : Publisher<Messages.PoseStampedPrimitive>
    {
        public Transform PublishedTransform;
        public string FrameId = "Unity";

        private Messages.PoseStampedPrimitive message;
        public int pmotion = 1;
        ...
        {
            message = new Messages.PoseStampedPrimitive
            {
